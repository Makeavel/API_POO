package br.generico.banco.Banco

import br.generico.banco.Banco.Conta.*
import br.generico.banco.Banco.Cliente.*
import br.generico.banco.Banco.Movimentacao.*

class Banco {

     // Criar apropriadamente as funções abaixo para usa-las no server.kt
